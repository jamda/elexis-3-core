...
public class GlobalActions {
	...
	public GlobalActions(final IWorkbenchWindow window) {
		...
		// helpAction.setText(Messages.getString("GlobalActions.HelpIndex"));
		// //$NON-NLS-1$
		...
		printKontaktEtikette = new Action(Messages.GlobalActions_PrintContactLabel) { // $NON-NLS-1$
			...
			public void run() {
				...
				EtiketteDruckenDialog dlg = new EtiketteDruckenDialog(mainWindow.getShell(), kontakt, TT_ADDRESS_LABEL);
	...
	public void adaptForUser() {
		...
		if (CoreHub.actUser != null) {
			boolean fixLayoutChecked = CoreHub.userCfg.get(Preferences.USR_FIX_LAYOUT,
	 ...
	 * 
	 * @param action
	 *            the action to activate. The action's actionDefinitionId must have
	 *            been set to the command's id (using
...
>>>>>>> 65b2aeea24297441ce19170fb521d15a74eddf57
